<h1 align="center"> create-your-app </h1>
<div align="center">

Interactive CLI template to quickly set up a new cli [Forked from create-t3-app](https://github.com/t3-oss/create-t3-app)
